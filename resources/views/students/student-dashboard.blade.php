                        ...
                        <div class="background-light d-flex card-body">
                            <div>
                                <svg xmlns="http://www.w3.org/2000/svg" width="61" height="61" viewBox="0 0 61 61" fill="none">
                                    ...
                                    <path d="M51.6363 51H10V49.1818H51.6363V51ZM12.5454 11H23.0363V51H12.5454V11ZM21.2182 12.8182H14.3635V49.1818H21.2182V12.8182ZM21.2363 21.4182H30V51H21.2363L21.2363 21.4182ZM28.1818 23.2363H23.0546V49.1818H28.1818V23.2363ZM38.5818 12.7273H49.0727V51H38.5818V12.7273ZM47.2545 14.5454H40.4V49.1818H47.2545V14.5454ZM28.1818 16.2H40.4181V51H28.1818V16.2ZM38.6 18.0182H30V49.1818H38.6V18.0182ZM29.0908 42.3272H22.1455V40.509H29.0909L29.0908 42.3272ZM36.0182 44.0546H32.5455V42.2363H36.0182L36.0182 44.0546ZM22.1455 44.0546H13.4545V42.2363H22.1454L22.1455 44.0546ZM22.1455 19.7637H13.4545V17.9454H22.1454L22.1455 19.7637Z" fill="white"/>
                                  </svg>
                            </div>
                    ...
                    <div class="card h-100">
                        <div class="background-light d-flex card-body">
                            <div>
                                <svg xmlns="http://www.w3.org/2000/svg" width="61" height="61" viewBox="0 0 61 61" fill="none">
                                    <rect width="61" height="61" rx="5" fill="#215D81"/>
                                    <path d="M31.0511 15C35.4831 15 39.4961 16.7967 42.4008 19.7014C45.3055 22.6061 47.1022 26.6191 47.1022 31.0511C47.1022 35.4831 45.3055 39.4961 42.4008 42.4008C39.4961 45.3053 35.4831 47.1022 31.0511 47.1022C26.6191 47.1022 22.6061 45.3053 19.7014 42.4008C16.7967 39.4961 15 35.4831 15 31.0511C15 26.6191 16.7967 22.6061 19.7014 19.7014C22.6061 16.7967 26.6191 15 31.0511 15ZM40.936 21.1662C38.4065 18.6365 34.9115 17.072 31.0511 17.072C27.1906 17.072 23.6957 18.6365 21.1662 21.1662C18.6365 23.6957 17.072 27.1906 17.072 31.0511C17.072 34.9114 18.6365 38.4065 21.1662 40.936C23.6955 43.4654 27.1906 45.0302 31.0511 45.0302C34.9115 45.0302 38.4067 43.4654 40.936 40.936C43.4657 38.4065 45.0302 34.9114 45.0302 31.0511C45.0302 27.1906 43.4657 23.6957 40.936 21.1662Z" fill="white" stroke="white" stroke-width="1.33342"/>
                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M11.072 31.0511C11.072 25.9452 13.0214 21.2946 16.2162 17.8034L14.6875 16.4052C11.1553 20.2653 9 25.4069 9 31.0511C9 36.6953 11.1553 41.8369 14.6875 45.697L16.2162 44.2988C13.0214 40.8076 11.072 36.157 11.072 31.0511Z" fill="white" stroke="white" stroke-width="1.33342"/>
                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M45.1865 17.8034C48.3813 21.2946 50.3307 25.9452 50.3307 31.0511C50.3307 36.157 48.3813 40.8076 45.1865 44.2988L46.7151 45.697C50.2474 41.8369 52.4027 36.6953 52.4027 31.0511C52.4027 25.4069 50.2474 20.2653 46.7151 16.4052L45.1865 17.8034Z" fill="white" stroke="white" stroke-width="1.33342"/>
                                    <path d="M31.0178 20.2918C31.0178 19.7199 30.5537 19.2558 29.9818 19.2558C29.4099 19.2558 28.9458 19.7199 28.9458 20.2918V31.0722C28.9458 31.3462 29.0524 31.5954 29.2262 31.7806L36.0841 39.9911C36.4507 40.429 37.1029 40.4871 37.5411 40.1205C37.979 39.7541 38.037 39.1017 37.6704 38.6637L31.0178 30.6992V20.2918Z" fill="white" stroke="white" stroke-width="1.33342"/>
                                  </svg>
                            </div>
                            <div class="ms-3 fw-bold" style="padding-top: 10px">
                                Study Hours<br>
                ...
                <div class="grid-container">
                        ...
                        <div class="card h-100">
                            <div class="background-light card-body">
                                <div class="text-center">
                                    <img src="{{url('assets/img/lang-icons/python.png')}} " width="50" height="50" alt="Python">
                                </div>
                    ...
                    <div class="grid-item">
                        ...
                        <div class="card h-100">
                            <div class="background-light card-body">
                                <div class="text-center">
                                    <img src="{{url('assets/img/lang-icons/java.png')}}" width="50" height="50" alt="java">
                                </div>
                                <div class="text-center fw-bold">
                                    JAVA
                                </div>
                                <div class="d-flex mt-3 justify-content-center">
                                    <label class="fw-bold ms-3 mx-4 pt-2" for="">60% Completed</label>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewgrid-item="0 0 32 32" fill="none">
                                        <g clip-path="url(#clip0_56_216)">
                                          <path fill-rule="evenodd" clip-rule="evenodd" d="M30.7892 9.88305C28.3868 4.08136 22.67 0 16 0C15.8777 0 15.7556 0.00137847 15.6339 0.00399755C15.5603 0.491699 15.5221 0.991118 15.5221 1.49922C15.5221 2.32313 15.6223 3.12347 15.8114 3.88907C15.8743 3.88797 15.937 3.88755 16 3.88755C21.0182 3.88755 25.3237 6.93934 27.1617 11.2881C27.7739 12.7365 28.1124 14.3287 28.1124 16C28.1124 22.6894 22.6894 28.1124 16 28.1124C13.8954 28.1124 11.916 27.5757 10.1916 26.6314C6.43496 24.5748 3.88755 20.5848 3.88755 16C3.88755 15.6609 3.90147 15.325 3.92891 14.993C2.86721 14.606 1.72088 14.3948 0.525196 14.3948C0.375494 14.3948 0.22662 14.3981 0.0785726 14.4046C0.0266044 14.9293 0 15.4614 0 16C0 22.1515 3.47153 27.4923 8.56248 30.1698C10.7844 31.3386 13.3149 32 16 32C24.8365 32 32 24.8365 32 16C32 13.8333 31.5694 11.7674 30.7892 9.88305Z" fill="#215D81"/>
                                          <path fill-rule="evenodd" clip-rule="evenodd" d="M3.92895 14.993C4.43567 8.83625 9.54689 3.9846 15.8115 3.88907C15.6223 3.12347 15.5221 2.32313 15.5221 1.49922C15.5221 0.991118 15.5603 0.491699 15.6339 0.0039978C7.50193 0.186782 0.867372 6.43634 0.0786133 14.4046C0.226661 14.3981 0.375535 14.3948 0.525237 14.3948C1.72092 14.3948 2.86725 14.606 3.92895 14.993Z" fill="#FF8B8B"/>
                                        </g>
                                        <defs>
                    ...
                    <div class="grid-item">
                        ...
                        <div class="card h-100">
                            <div class="background-light card-body">
                                <div class="text-center">
                                    <img src="{{url('assets/img/lang-icons/angular.png')}}" width="50" height="50" alt="angular">
                                </div>
                                <div class="text-center fw-bold">
                                    ANGULAR
                                </div>
                                <div class="d-flex mt-3 ms-3 mx-4 pt-2 fw-bold justify-content-center">
                                    Start the Course
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card h-100">
                            <div class="background-light card-body">
                                <div class="">
                                    <div class="first" >
                                        <div class="text-center">
                                            <img src="{{url('assets/img/lang-icons/c.png')}}" width="50" height="50" alt="c">
                                        </div>
                                        <div class="text-center fw-bold">
                                            C
                                        </div>

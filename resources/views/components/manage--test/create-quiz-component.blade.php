<div class="row col-12">
    ...
    <div class="table-container">
        <table id="dataTable2" class="table table-responsive table-stripped ">
            <thead class="">
                ...
                <tr class="background-grey">
                    ...
                    <td><input type="search" name="" class="form-control table-search-bar"
                            placeholder="Search Visibility " id="">
                    </td>
                    <td><input type="search" name="" class="form-control table-search-bar"
    ...
    <div class="col-md-4">
        <div id="pagination2" class="d-flex justify-content-center mt-4"></div>
    </div>
</div>

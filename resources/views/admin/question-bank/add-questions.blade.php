                ...
                <div class="  col-12 fw-bold">
                    <div class="row">
                        ...
                        <div class="col-6">
                            ...
                            <select name="" class="custom-select my-select form-control" id="category" required>
                                <option value="" selected disabled>SELECT</option>
                        ...
                        <div class="col-6">
                            ...
                            <select name="" class="custom-select my-select form-control" id="topics" required>
                                ...
                                <option value="2">Statements</option>
                    ...
                    <div class="mt-2">
                        ...
                        <div class="d-flex">
                            <input type="checkbox" name="" class="checkbox" onclick="toggleCheck(this)"
                                id="">
                            <input type="text" name="" class="form-control mb-4" placeholder="Option A"
                                id="">
                        </div>
                    </div>
                    <div class="mt-2">
                        ...
                        <div class="d-flex">
                            <input type="checkbox" name="" class="checkbox" onclick="toggleCheck(this)"
                                id="">
                            <input type="text" name="" class="form-control mb-4" placeholder="Option B"
                                id="">
                        </div>
                    </div>
                    <div class="mt-2">
                        ...
                        <div class="d-flex">
                            <input type="checkbox" name="" class="checkbox" onclick="toggleCheck(this)"
                                id="">
                            <input type="text" name="" class="form-control mb-4" placeholder="Option C"
                                id="">
                        </div>
                    </div>
                    <div class="mt-2">
                        ...
                        <div class="d-flex">
                            <input type="checkbox" name="" class="checkbox" onclick="toggleCheck(this)"
                                id="">
                            <input type="text" name="" class="form-control mb-4" placeholder="Option D"
                                id="">
                        </div>
                    </div>

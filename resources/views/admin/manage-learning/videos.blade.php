...
@section('content')
    <div class="container mt-4">
        <div class="col-6 mx-auto mt-4 py-4">

            {{-- add and remove videos section --}}
            <div class="text-center">
                <button class="btn background-secondary radius text-white ms-2">Add Video</button>
                <button class="btn background-secondary radius text-white ms-2">Remove Video</button>
            </div>
